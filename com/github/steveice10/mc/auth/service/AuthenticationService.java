...
public class AuthenticationService {
    private static String BASE_URL = "http://authserver.mojang.com/";
    ...
    public void setUsingTheAltening(boolean usingTheAltening)
    {
        if(usingTheAltening)
        {
            BASE_URL = BASE_URL.replace("mojang","thealtening");
            AUTHENTICATE_URL = BASE_URL + "authenticate";

        }
        else
        {
            BASE_URL = BASE_URL.replace("thealtening","mojang");
            AUTHENTICATE_URL = BASE_URL + "authenticate";
        }
    }
    /**
