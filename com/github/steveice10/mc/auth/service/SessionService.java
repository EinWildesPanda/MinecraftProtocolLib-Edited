...
public class SessionService {
    private static String BASE_URL = "http://sessionserver.thealtening.com/session/minecraft/";
    ...
    private static PublicKey SIGNATURE_KEY;
     ...
     */
    public SessionService(Proxy proxy, boolean theAltening) {
        if(proxy == null) {
        ...
        if(theAltening)
        {
            ...
            BASE_URL = "http://sessionserver.thealtening.com/session/minecraft/";
            JOIN_URL = BASE_URL + "join";
            HAS_JOINED_URL = BASE_URL + "hasJoined";
