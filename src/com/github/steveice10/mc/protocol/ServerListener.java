...
import de.panda.stresstest.Stresstester;
    ...
    private class UserAuthTask implements Runnable {
        ...
        public void run() {
            ...
            if(verify && this.key != null) {
                ...
                try {
                    profile = new SessionService(proxy, Stresstester.isUsingTheAltening()).getProfileByServer(username, new BigInteger(CryptUtil.getServerIdHash(serverId, KEY_PAIR.getPublic(), this.key)).toString(16));
